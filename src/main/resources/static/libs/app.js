 ...
 * AdminLTE
 * 
 * @type Object @description $.AdminLTE is the main object for the template's
 * app. It's used for implementing functions and options related to the
 * template. Keeping everything wrapped in an object prevents conflict with
 * other plugins and is a better way to organize our code.
 */
$.AdminLTE = {};

/*
 * -------------------- - AdminLTE Options - -------------------- Modify these
 ...
 * code implements AdminLTE's functions and plugins as specified by the options
 * above.
 */
$(function() {
	"use strict";
 ...
 * ---------------------------------- All AdminLTE functions are implemented
 * below.
 */
function _init() {
	'use strict';
	 ...
	 * 
	 * @type Object @usage $.AdminLTE.layout.activate() $.AdminLTE.layout.fix()
	...
	$.AdminLTE.layout = {
		...
		fix : function() {
			...
			var neg = $('.main-header').outerHeight() + $('.main-footer').outerHeight() + 1;
	 ...
	 * 
	 * @type Function @usage: $.AdminLTE.pushMenu("[data-toggle='offcanvas']")
	 */
	$.AdminLTE.pushMenu = {
	 ...
	 * 
	 * @type Function @Usage: $.AdminLTE.tree('.sidebar')
	 */
	...
	/*
	 * BoxWidget ========= BoxWidget is a plugin to handle collapsing and
	 * removing boxes from the screen.
	 * 
	 * @type Object @usage $.AdminLTE.boxWidget.activate() Set all your options
	 * in the main $.AdminLTE.options object
	 */
	$.AdminLTE.boxWidget = {
