...
!function (a) {
    ...
    $.jgrid = $.jgrid || {}, $.jgrid.hasOwnProperty("defaults") || ($.jgrid.defaults = {}), $.extend($.jgrid, {
        ...
        parseDate: function (a, b, c, d) {
            ...
            var
                s = o.getHours(), t = o.getMinutes(), u = o.getDate(), v = o.getMonth() + 1, w = o.getTimezoneOffset(),
            ...
            var
                $t = this, QueryObject = function (d, q) {
                    "string" == typeof
                        d && (d = $.data(d));
                    var
                        self = this, _data = d, _usecase = !0, _trim = !1, _query = q, _stripNum = /[\$,%]/g,
                    ...
                    return d.length > 0 && (_useProperties = "object" != typeof
                        ...
                        var
                            c = _sorting[b].by, d = _sorting[b].dir, e = _sorting[b].type, f = _sorting[b].datefmt,
                            g = _sorting[b].sfunc;
        ...
        return this.each(function () {
            if (!this.grid) {
                ...
                var
                    d = this, e = {
                        headers: [], cols: [], footers: [], dragStart: function (a, b, e) {
                            ...
                            if (this.resizing) {
                                var
                                    b, d, e = a.pageX - this.resizing.startX, f = this.headers[this.resizing.idx],
                            ...
                            if (a) {
                                ...
                                if (f) {
                                    e.prevRowHeight = f;
                                    var
                                        i, j, k, l = c.rowNum, m = e.scrollTop = e.bDiv.scrollTop,
                            ...
                            var
                                b = a.p, c = b.selrow, d = b.selarrrow ? $.makeArray(b.selarrrow) : null,
                ...
                var
                    ...
                    q = k(l, "icon_base", !0), r = $.jgrid.styleUI[d.p.styleUI || "jQueryUI"].colmenu,
                    s = $.jgrid.msie(), t = [], u = [], v = [];
                ...
                var
                    x, y = ["shiftKey", "altKey", "ctrlKey"], z = function (a, b) {
                        ...
                        var
                            a, b, c, e, f, g, h, i, j, k, l, m = d.p, n = m.data, o = n.length, p = m.localReader,
                        ...
                        var
                            f = new
                            Date, g = "local" !== d.p.datatype && d.p.loadonce || "xmlstring" === d.p.datatype, h = "_id_",
                            i = d.p.xmlReader, j = "local" === d.p.datatype ? "local" : "xml";
                        if (g && (d.p.data = [], d.p._index = {}, d.p.localReader.id = h), d.p.reccount = 0, $.isXMLDoc(a)) {
                            ...
                            var
                                m, n, o, p, q, r, s, t, u, v, w = $(d), x = 0, y = d.p.multiselect === !0 ? 1 : 0, A = 0,
                                B = d.p.rownumbers === !0 ? 1 : 0, C = [], J = {}, K = [],
                            ...
                            var
                                P, Q = O.length, R = 0, S = [], T = parseInt(d.p.rowNum, 10),
                                U = d.p.scroll ? $.jgrid.randId() : 1, V = $("#" + $.jgrid.jqID(d.p.id) + " tbody:first");
                            if (Q > 0 && d.p.page <= 0 && (d.p.page = 1), O && Q) {
                                e && (T *= e + 1);
                                var
                                    W, X = $.isFunction(d.p.afterInsertRow), Y = !1,
                        ...
                        if (a) {
                            ...
                            var
                                m, o, p, q, r, s, t, u, v, w, x, y, A = $(d), B = 0, C = [], J = d.p.multiselect ? 1 : 0,
                                K = d.p.subGrid === !0 ? 1 : 0, M = d.p.rownumbers === !0 ? 1 : 0, N = H(J + K + M),
                                O = G(h), P = {}, Q = [], R = d.p.altRows === !0 ? d.p.altclass : "",
                            ...
                            var
                                Y, Z = $.isFunction(d.p.afterInsertRow), _ = [], aa = !1,
                        ...
                        if ($.isArray(d.p.data)) {
                            ...
                            var
                                w = r.select(), x = parseInt(d.p.rowNum, 10), y = w.length, z = parseInt(d.p.page, 10),
                                A = Math.ceil(y / x), B = {};
                        ...
                        var
                            c, e, f, g, h, i, j, n, p = "", q = d.p.pager ? $.jgrid.jqID(d.p.pager.substr(1)) : "",
                        ...
                        var
                            a, b, c, f, g = 0, h = $.jgrid.cell_width ? 0 : z(d.p.cellLayout, 0), i = 0,
                            j = z(d.p.scrollOffset, 0), k = !1, l = 0;
                        ...
                        var
                            e, f, g = d.p.colModel, h = g.length, i = [], j = $.jgrid.getRegional(d, "colmenu"),
                        ...
                        var
                            f, g, h, i, j, k = d.p.colModel[a], l = "", m = "", n = "", p = "", q = "", s = "",
                            t = ["eq", "ne", "lt", "le", "gt", "ge", "nu", "nn", "in", "ni"],
                            u = ["eq", "ne", "bw", "bn", "ew", "en", "cn", "nc", "nu", "nn", "in", "ni"],
                            v = $.jgrid.getRegional(d, "search"), w = $.jgrid.styleUI[d.p.styleUI || "jQueryUI"].common;
                        if (k) {
                ...
                var
                    ia, ja, ka, la, ma, na, oa, pa, qa, ra = "<thead><tr class='ui-jqgrid-labels' role='row'>", sa = "",
                    ta = "", ua = "";
        ...
        getGridParam: function (a, b) {
            ...
            return this.each(function () {
                ...
                d(a) {
                    var
                        b = $(l.grid.bDiv)[0].clientHeight, c = $(l.grid.bDiv)[0].scrollTop,
                ...
                var
                    e, f, g, h, i, j, k, l = this, m = $.jgrid.getMethod("getStyleUI"),
            ...
            return this.each(function () {
                var
                    b, c, d = this, e = $.jgrid.getMethod("getStyleUI"),
            ...
            return this.each(function () {
                if (this.grid) {
                    var
                        c, d, e, f, g = this, h = 0, i = $.jgrid.cell_width ? 0 : g.p.cellLayout, j = 0, k = !1,
                        l = g.p.scrollOffset, m = 0, n = "Bootstrap" === g.p.styleUI ? 2 : 0;
                    if ("boolean" != typeof
            ...
            return a = $.extend({
                ...
                var
                    b, c, d = "show" === a.method ? !0 : !1, e = $("#load_" + $.jgrid.jqID(this.p.id)),
                    f = $(window).scrollTop();
            ...
            return this.each(function () {
                if (this.grid) {
                    var
                        b = this, c = $(this).jqGrid("getStyleUI", this.p.styleUI + ".base", "icon_caption_open", !0),
            ...
            return this.each(function () {
                ...
                void
                    ...
                    try {
                        var
                            a = $(window).width(), c = $("#gbox_" + $.jgrid.jqID(b.p.id)).parent().width(),
                            d = b.p.width;
...
!function (a) {
    ...
    a.fmatter = {}, a.extend(a.fmatter, {
        ...
        var
            c = a(this).closest("tr.jqgrow"), d = c.attr("id"),
            e = a(this).closest("table.ui-jqgrid-btable").attr("id").replace(/_frozen([^_]*)$/, "$1"), f = a("#" + e),
            g = f[0], h = g.p, i = h.colModel[a.jgrid.getCellIndex(this)],
            j = i.frozen ? a("tr#" + d + " td:eq(" + a.jgrid.getCellIndex(this) + ") > div", f) : a(this).parent(),
            k = {extraparam: {}}, l = function (b, c) {
        ...
        var
            d, e = {keys: !1, editbutton: !0, delbutton: !0, editformbutton: !1}, f = c.rowId, g = "",
            h = a.jgrid.getRegional(this, "nav"), i = a.jgrid.styleUI[c.styleUI || "jQueryUI"].fmatter,
        ...
        var
            f, g, h = c.colModel.formatter, i = c.colModel.formatoptions || {}, j = /([\.\*\_\'\(\)\{\}\+\?\\])/g,
...
!function (a) {
    ...
    a.extend(a.jgrid, {
        showModal: function (a) {
            ...
            var
                i = this, j = "rtl" === a(d.gbox).attr("dir") ? !0 : !1,
                k = a.jgrid.styleUI[d.styleUI || "jQueryUI"].modal, l = a.jgrid.styleUI[d.styleUI || "jQueryUI"].common,
            ...
            if (j && q.left && !g && (t = a(d.gbox).width() - (isNaN(d.width) ? 0 : parseInt(d.width, 10)) - 8, q.left = parseInt(q.left, 10) + parseInt(t, 10)), q.left && (q.left += "px"), a(m).css(a.extend({
                ...
                zIndex: d.zIndex,
                overflow: "hidden"
            }, q)).attr({tabIndex: "-1", role: "dialog", "aria-labelledby": b.modalhead, "aria-hidden": "true"}), void
            ...
            var
                g = f.jqModal, h = this, i = a.jgrid.styleUI[f.styleUI || "jQueryUI"].modal,
            ...
            var
                m = isNaN(f.dataheight) ? f.dataheight : f.dataheight + "px", n = "text-align:" + f.align + ";",
                o = "<div id='info_id'>";
                ...
                case"select":
                    ...
                    if (c.multiple === !0 ? (l = !0, h.multiple = "multiple", a(h).attr("aria-multiselectable", "true")) : l = !1, null != c.dataUrl) {
                        ...
                        i.p && i.p.idPrefix && (n = a.jgrid.stripPref(i.p.idPrefix, n)), a.ajax(a.extend({
                            ...
                            success: function (b) {
                                var
                                    c, d = [], e = this.elem, f = this.vl, h = a.extend({}, this.options),
                                    j = h.multiple === !0, k = h.cacheUrlData === !0, l = "",
...
!function (a) {
    ...
    a.jgrid.extend({
        editGridRow: function (c, d) {
            var
                e = a.jgrid.getRegional(this[0], "edit"), f = this[0].p.styleUI, g = a.jgrid.styleUI[f].formedit,
            ...
            return d = a.extend(!0, {
                ...
                f(c, d, e, f) {
                    var
                        h, i, j, k, l, m, n, o, p = 0, q = [], r = !1,
                        t = "<td class='CaptionTD'>&#160;</td><td class='DataTD'>&#160;</td>", u = "";
                    for (n = 1; f >= n; n++) u += t;
                    if ("_empty" !== c && (r = a(d).jqGrid("getInd", c)), a(d.p.colModel).each(function (n) {
                        if (h = this.name, i = this.editrules && this.editrules.edithidden === !0 ? !1 : this.hidden === !0 ? !0 : !1, l = i ? "style='display:none'" : "", "cb" !== h && "subgrid" !== h && this.editable === !0 && "rn" !== h) {
                            ...
                            var
                                v = a.extend({}, this.editoptions || {}, {id: h, name: h, rowId: c, oper: "edit"}),
                                w = a.extend({}, {
                                    elmprefix: "",
                                    elmsuffix: "",
                                    rowabove: !1,
                                    rowcontent: ""
                                }, this.formoptions || {}), x = parseInt(w.rowpos, 10) || p + 1,
                ...
                k() {
                    var
                        c, e, f, g, k, l, m, n = [!0, "", ""], o = {}, p = s.p.prmNames,
                ...
                if (s.grid && c) {
                    ...
                    var
                        I,
                        J = isNaN(b[a(this)[0].p.id].dataheight) ? b[a(this)[0].p.id].dataheight : b[a(this)[0].p.id].dataheight + "px",
                    ...
                    if (F ? (I = q(b[a(this)[0].p.id].template), t = A) : (I = a("<table id='" + z + "' class='EditTable ui-common-table'><tbody></tbody></table>"), t = A + "_2"), y = "#" + a.jgrid.jqID(y), a(L).append("<div class='FormError " + h.error + "' style='display:none;'></div>"), a(L).append("<div class='tinfo topinfo'>" + b[s.p.id].topinfo + "</div>"), a(s.p.colModel).each(function () {
                        ...
                        n(), f(c, s, I, D);
                        var
                            M = "rtl" === s.p.direction ? !0 : !1, N = M ? "nData" : "pData", O = M ? "pData" : "nData",
            ...
            var
                e = a.jgrid.getRegional(this[0], "view"), f = this[0].p.styleUI, g = a.jgrid.styleUI[f].formedit,
                h = a.jgrid.styleUI[f].common;
            return d = a.extend(!0, {
                top: 0,
                left: 0,
                ...
                f(b, c, e, f) {
                    var
                        ...
                        w = ["integer", "number", "currency"], x = 0, y = 0;
                    ...
                    if (a(c.p.colModel).each(function () {
                        ...
                        if (g = this.name, o = !1, i = this.editrules && this.editrules.edithidden === !0 ? !1 : this.hidden === !0 ? !0 : !1, l = i ? "style='display:none'" : "", p = "boolean" != typeof
                            ...
                            var
                                d = a.extend({}, {rowabove: !1, rowcontent: ""}, this.formoptions || {}),
                ...
                if (l.grid && c) {
                    var
                        m = l.p.id, n = "ViewGrid_" + a.jgrid.jqID(m), o = "ViewTbl_" + a.jgrid.jqID(m),
                        p = "ViewGrid_" + m, q = "ViewTbl_" + m, r = {
                            themodal: "viewmod" + m,
                            modalhead: "viewhd" + m,
                    ...
                    if (a(l.p.colModel).each(function () {
                        ...
                        f(c, l, z, u);
                        var
                            A = "rtl" === l.p.direction ? !0 : !1, B = A ? "nData" : "pData", C = A ? "pData" : "nData",
            ...
            var
                e = a.jgrid.getRegional(this[0], "del"), f = this[0].p.styleUI, g = a.jgrid.styleUI[f].formedit,
                h = a.jgrid.styleUI[f].common;
            return d = a.extend(!0, {
                top: 0,
                left: 0,
                ...
                if (e.grid && c) {
                    var
                        ...
                        n = a.isFunction(b[e.p.id].beforeInitData) ? b[e.p.id].beforeInitData : !1, o = e.p.id, p = {},
                        q = !0, r = "DelTbl_" + a.jgrid.jqID(o), s = "DelTbl_" + o,
                        t = {themodal: "delmod" + o, modalhead: "delhd" + o, modalcontent: "delcnt" + o, scrollelm: r};
            ...
            var
                i = a.jgrid.getRegional(this[0], "nav"), j = this[0].p.styleUI, k = a.jgrid.styleUI[j].navigator,
                ...
                if (!this.p.navGrid) {
                    ...
                    if (p.grid && "string" == typeof
                        ...
                        for (n.cloneToTop && p.p.toppager && (r = 2), q = 0; r > q; q++) {
                            var
                                u, v, w,
                                x = a("<table class='ui-pg-table navtable ui-common-table'><tbody><tr></tr></tbody></table>"),
            ...
            return c = a.extend({
                ...
                if (this.grid) {
                    ...
                    var
                        e = a(".navtable", b)[0], f = this, g = a.jgrid.styleUI[d].common.disabled,
                        h = a.jgrid.styleUI[d].common.hover, i = a.jgrid.styleUI[d].common.cornerall,
                    ...
                    if (f.p.storeNavOptions && !c.internal && f.p.navButtons.push([b, c]), e) {
                        ...
                        var
                            l = a(e).val(), m = c.id || a.jgrid.randId(),
            ...
            return this.each(function () {
                var
                    j = this, k = a.jgrid.getRegional(j, "nav"), l = j.p.styleUI,
                    m = (a.jgrid.styleUI[l].navigator, a.jgrid.styleUI[l].filter), n = a.jgrid.styleUI[l].common,
            ...
            if (!this.filter) {
                ...
                if (this.p.initFilter = a.extend(!0, {}, this.p.filter), d) {
                    ...
                    var
                        ...
                        }, h = g(), i = a.jgrid.styleUI[h.p.styleUI || "jQueryUI"].filter,
                    ...
                    this.onchange = function () {
                        ...
                        if (this.p.groupButton && (p = a("<input type='button' value='+ {}' title='Add subgroup' class='add-group " + j.button + "'/>"), p.bind("click", function () {
                            ...
                            var
                                q,
                                r = a("<input type='button' value='+' title='Add rule' class='add-rule ui-add " + j.button + "'/>");
                        ...
                        for (d = 0; d < n.p.columns.length; d++) {
                            var
                                ...
                                x = n.p.columns[d].hidden === !0, y = n.p.columns[d].searchoptions.searchhidden === !0;
            ...
            return b = a.extend({
                ...
                if (!d.p.filterToolbar) {
                    ...
                    var
                        ...
                        j = a.jgrid.styleUI[d.p.styleUI || "jQueryUI"].base, k = function () {
                            var
                            ...
                            c = "boolean" != typeof
                                ...
                                var
                                    b,
                                    c = a("#gs_" + d.p.idPrefix + a.jgrid.jqID(this.name), this.frozen === !0 && d.p.frozenColumns === !0 ? d.grid.fhDiv : d.grid.hDiv);
                ...
                if (d.grid) {
                    var
                        e, f = "fbox_" + d.p.id, g = !0, h = !0, i = {
                            ...
                            scrollelm: f
                        }, j = d.p.postData[b.sFilter], k = a.jgrid.styleUI[d.p.styleUI || "jQueryUI"].filter,
                    ...
                    if (b.styleUI = d.p.styleUI, "string" == typeof
                        ...
                        if (b.showQuery && (u = "<a id='" + f + "_query' class='fm-button " + l.button + " fm-button-icon-left'><span class='" + l.icon_base + " " + k.icon_query + "'></span>Query</a>"), b.columns.length ? (r = b.columns, x = 0, p = r[0].index || r[0].name) : a.each(r, function (a, b) {
                            if (b.label || (b.label = d.p.colNames[a]), !w) {
                                var
                                    c = void
                                        0 === b.search ? !0 : b.search, e = b.hidden === !0,
...
!function (a) {
    ...
    a.jgrid.inlineEdit = a.jgrid.inlineEdit || {}, a.jgrid.extend({
        editRow: function (b, c, d, e, f, g, h, i, j) {
            ...
            var
                w = a.jgrid.getRegional(k, "errors"), x = a.jgrid.getRegional(k, "edit"),
...
!function (a) {
    ...
    a.jgrid.extend({
        editCell: function (b, c, d) {
            return this.each(function () {
                var
                    e, f, g, h, i = this, j = a(this).jqGrid("getStyleUI", i.p.styleUI + ".common", "highlight", !0),
            ...
            return this.each(function () {
                ...
                if (e.grid && e.p.cellEdit === !0) {
                    if (d = e.p.savedRow.length >= 1 ? 0 : null, null !== d) {
                        var
                            h, i, j = a("td:eq(" + c + ")", e.rows[b]), k = e.p.colModel[c], l = k.name,
                            m = a.jgrid.jqID(l), n = a(j).offset();
                        switch (k.edittype) {
                            case"select":
            ...
            return this.each(function () {
                ...
                b(b, c, e) {
                    if ("v" === e.substr(0, 1)) {
                        var
                            f = a(d.grid.bDiv)[0].clientHeight, g = a(d.grid.bDiv)[0].scrollTop,
                            h = d.rows[b].offsetTop + d.rows[b].clientHeight, i = d.rows[b].offsetTop;
                    ...
                    if ("h" === e) {
                        var
                            j = a(d.grid.bDiv)[0].clientWidth, k = a(d.grid.bDiv)[0].scrollLeft,
                ...
                if (d.grid && d.p.cellEdit === !0) {
                    ...
                    var
                        e, f,
                        g = a("<div style='position:fixed;top:0px;width:1px;height:1px;' tabindex='0'><div tabindex='-1' style='width:1px;height:1px;' id='" + d.p.knv + "'></div></div>");
            ...
            return this.each(function () {
                ...
                if (d.grid) {
                    var
                        ...
                        k = a.jgrid.styleUI[d.p.styleUI || "jQueryUI"].common, l = function (b, c, e) {
                            var
                            ...
                            var
                                e, f, g, h, i, m,
                                n = a("<table class='" + j.rowTable + " ui-common-table'><tbody></tbody></table>"),
                                o = a("<tr></tr>");
    ...
    a.jgrid.extend({
        groupingSetup: function () {
            ...
            return this.each(function () {
                ...
                var
                    g, h, i = e.join("_"), j = d.minusicon, k = d.plusicon, l = a("#" + a.jgrid.jqID(b)),
                    m = l.length ? l[0].nextSibling : null,
                    n = a("#" + a.jgrid.jqID(b) + " span.tree-wrap-" + c.p.direction), o = function (b) {
                        var
                        ...
                        return c.length > 0 ? c[0] : void
                            0
                    }, p = !1, q = !1, r = c.p.frozenColumns ? c.p.id + "_frozen" : !1,
            ...
            return this.each(function () {
                ...
                var
                    h, i, j, k = this, l = k.p.groupingView, m = "", n = "",
                    o = l.groupCollapse ? l.plusicon : l.minusicon, p = [], q = l.groupField.length,
            ...
            return b = a.extend({useColSpanStyle: !1, groupHeaders: []}, b || {}), this.each(function () {
                var
                    c, d, e, f, g, h, i, j, k, l, m, n, o, p, q = this, r = 0, s = q.p.colModel, t = s.length,
                    u = q.grid.headers, v = a("table.ui-jqgrid-htable", q.grid.hDiv),
                    w = v.children("thead").children("tr.ui-jqgrid-labels:last").addClass("jqg-second-row-header"),
                    x = v.children("thead"), y = v.find(".jqg-first-row-header"),
            ...
            return void
                ...
                var
                    c, d, e, f, g, h, i, j = this, k = j.grid, l = a("table.ui-jqgrid-htable thead", k.hDiv),
                    m = j.p.colModel;
                if (k) {
        ...
        setTreeNode: function (b, c) {
            return this.each(function () {
                ...
                if (d.grid && d.p.treeGrid) {
                    var
                        e, f, g, h, i, j, k, l, m = d.p.expColInd, n = d.p.treeReader.expanded_field,
            ...
            return this.each(function () {
                ...
                if (d.grid && d.p.treeGrid) switch (d.p.treeGridModel) {
                    case"nested":
                        var
                            e = d.p.treeReader.left_field, f = d.p.treeReader.right_field,
                            g = d.p.treeReader.level_field, h = parseInt(b[e], 10), i = parseInt(b[f], 10),
                            j = parseInt(b[g], 10);
            ...
            return this.each(function () {
                ...
                if (e.grid && e.p.treeGrid) {
                    ...
                    switch (e.p.treeGridModel) {
                        case"nested":
                            var
                                i = e.p.treeReader.left_field, j = e.p.treeReader.right_field,
                                k = e.p.treeReader.level_field, l = parseInt(b[i], 10), m = parseInt(b[j], 10),
                                n = parseInt(b[k], 10);
            ...
            return this.each(function () {
                ...
                if (f.grid && f.p.treeGrid) switch ((null == c || "boolean" != typeof
                    ...
                    case"nested":
                        var
                            h = f.p.treeReader.left_field, i = f.p.treeReader.right_field,
                            j = f.p.treeReader.level_field, k = parseInt(b[h], 10), l = parseInt(b[i], 10),
                            m = parseInt(b[j], 10);
                        a(this.p.data).each(function () {
            ...
            return this.each(function () {
                var
                    e = a.jgrid.getAccessor(b, this.p.localReader.id), f = a("#" + e, this.grid.bDiv)[0],
            ...
            return this.each(function () {
                if (this.grid && this.p.treeGrid) {
                    ...
                    var
                        f = this.p.treeReader.expanded_field, g = this.p.treeReader.parent_id_field,
                        h = this.p.treeReader.loaded, i = this.p.treeReader.level_field,
                        j = this.p.treeReader.leaf_field, k = this.p.treeReader.left_field,
            ...
            return this.each(function () {
                if (this.grid && this.p.treeGrid) {
                    var
                        c = this.p.treeReader.expanded_field, d = this.p.treeReader.parent_id_field,
                    ...
                    if (!b[c]) {
                        var
                            ...
                            j = a("#" + this.p.idPrefix + a.jgrid.jqID(i), this.grid.bDiv)[0], k = this.p._index[i],
            ...
            return this.each(function () {
                var
                    c, d, e, f, g, h = this, i = h.p.localReader.id, j = h.p.treeReader.left_field,
            ...
            return this.each(function () {
                var
                    c, d, e, f, g = this, h = g.p.localReader.id, i = g.p.treeReader.left_field,
            ...
            if (d) {
                var
                    g, h, i, j, k, l, m, n, o = f.p.treeReader.expanded_field, p = f.p.treeReader.leaf_field,
...
!function (a) {
    ...
    a.assocArraySize = function (a) {
        ...
        pivotSetup: function (c, d) {
            var
                e = [], f = [], g = [], h = [], i = [],
                j = {grouping: !0, groupingView: {groupField: [], groupSummary: [], groupSummaryPos: []}}, k = [],
                l = a.extend({
                    rowTotals: !1,
                    rowTotalsText: "Total",
                    colTotals: !1,
            ...
            return this.each(function () {
                ...
                f(b) {
                    var
                        ...
                        k = a.assocArraySize(j.summary) > 0 ? !0 : !1, l = a.jgrid.from.call(g, j.rows);
    ...
    a.jgrid = a.jgrid || {}, a.extend(a.jgrid, {
        saveState: function (b, c) {
            ...
            if (d = a.extend(d, c || {}), d.regional) {
                ...
                var
                    e = a("#" + b)[0], f = a(e).jqGrid("getGridParam", "colModel"), g = -1,
...
!function (a) {
    ...
    $.jgrid.extend({
        sortableColumns: function (a) {
            ...
            var
                d, e, f, g, h, i, j, k = this, l = {}, m = [], n = k.jqGrid("getGridParam", "colModel"),
